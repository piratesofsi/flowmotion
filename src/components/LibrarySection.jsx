...
@keyframes typingBounce {
  ...
  // ── BUTTONS ──────────────────────────────────────────────────────
  {
    ...
    preview: (
      <button
        className="px-5 py-2.5 bg-purple-600 text-white text-sm font-medium rounded-lg"
...
@keyframes jellyPop {
  ...
  // ── TEXT EFFECTS ─────────────────────────────────────────────────
  {
    ...
    preview: (
      <p
        className="text-purple-600 font-medium text-sm overflow-hidden whitespace-nowrap border-r-2 border-purple-600"
        style={{
      ...
      <div style={{ display: "flex", gap: 6, flexWrap: "wrap", justifyContent: "center" }}>
        {["Craft", "Smooth", "UI", "Motion"].map((word, i) => (
          <span key={word} style={{
            ...
            fontSize: 18, fontWeight: 600, color: "#9333ea",
